...
/*
compute the Discrete Fourier transform, it accepts a limit because in some cases we may just need
a small part of the sequence, if you need the full sequence pass to limit the same value of length
*/
